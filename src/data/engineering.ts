...
export const engineeringCategories: EngineeringCategory[] = [
  {
    ...
    media: [
      vehicleImage("jeep-gladiator-3-6l-pentastar-supercharger-system.png", "Jeep Gladiator 3.6L Pentastar Supercharger System"),
      vehicleImage("jeep-grand-cherokee-3-6l-pentastar-supercharger-system.png", "Jeep Grand Cherokee 3.6L Pentastar Supercharger System"),
      vehicleImage("jeep-wrangler-3-0l-pentastar-supercharger-system.png", "Jeep Wrangler 3.0L Pentastar Supercharger System"),
      vehicleImage("jeep-wrangler-3-6l-pentastar-supercharger-system.png", "Jeep Wrangler 3.6L Pentastar Supercharger System"),
      vehicleImage("nissan-patrol-4-0l-vq40-installed.jpg", "Nissan Patrol 4.0L VQ40 Supercharger System"),
      vehicleImage("suzuki-jimny-1-5l-k15-supercharger-system.png", "Suzuki Jimny 1.5L K15B Supercharger System"),
      vehicleImage("toyota-alphard-vellfire-2-5l-30-series-2ar-fe-supercharger-system.png", "Toyota Alphard / Vellfire 2.5L 2AR-FE Supercharger System"),
      vehicleImage("toyota-alphard-vellfire-2-5l-30-series-2ar-fxe-supercharger-system.png", "Toyota Alphard / Vellfire 2.5L 2AR-FXE Supercharger System"),
      vehicleImage("toyota-land-cruiser-4-0l-1gr-dvvt-installed.jpg", "Toyota Land Cruiser 4.0L 1GR DVVT Supercharger System"),
      vehicleImage("toyota-land-cruiser-4-0l-1gr-dvvt-supercharger-system.jpg", "Toyota Prado & FJ 4.0L 1GR DVVT Supercharger System"),
      vehicleImage("toyota-lc70-series-4-0l-1gr-vvt-supercharger-system.jpg", "Toyota LC70 Series 4.0L 1GR VVT Supercharger System"),
      vehicleImage("toyota-prado-4-0l-1gr-dvvt-installed.jpg", "Toyota Prado & FJ 4.0L 1GR VVT Supercharger System"),
      vehicleImage("toyota-prado-fj-4-0l-1gr-vvt-supercharger-system.jpg", "Toyota Prado / FJ 4.0L 1GR VVT Supercharger System"),
      vehicleImage("toyota-prado-2-7l-2tr-supercharger-system.png", "Toyota Prado 2.7L 2TR Supercharger System"),
      vehicleImage("toyota-tacoma-prado-3-5l-2gr-7gr-supercharger-system.png", "Toyota Tacoma / Prado 3.5L 2GR & 7GR Supercharger System"),
    ],
  },
  {
